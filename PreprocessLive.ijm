...
selectWindow("TrackMate capture of ALIGNED_SCALED_MAX_" + rootname + "combined");
saveAs("Tiff", path2save + File.separator + "TrackMate capture of ALIGNED_SCALED_MAX_" + rootname + "combined.tif");
