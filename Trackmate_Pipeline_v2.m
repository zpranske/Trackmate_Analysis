...
function [edgeinfo] = process_edges(spot_table,edge_map,frame_range,filename)
    ...
    for i = 1:edge_map.Count
        ...
        if(height(edge_info_i)>0)
            ...
            % this track
            mean_spot_intensity_ch1 = mean(edge_info_i.MEAN_INTENSITY_CH1);
            mean_spot_intensity_ch2 = mean(edge_info_i.MEAN_INTENSITY_CH2);
            mean_quality = mean(edge_info_i.QUALITY);
            mean_signoise_ch1 = mean(edge_info_i.SNR_CH1);
            mean_signoise_ch2 = mean(edge_info_i.SNR_CH2);
            mean_contrast_ch1 = mean(edge_info_i.CONTRAST_CH1);
            mean_contrast_ch2 = mean(edge_info_i.CONTRAST_CH2);
            ...
            edgeinfo(i,:) = table(string(filename),double(i), n_spots, ...
                ...
                mean_spot_intensity_ch1, mean_spot_intensity_ch2, ...
                mean_signoise_ch1, mean_signoise_ch2, ...
                mean_contrast_ch1, mean_contrast_ch2);
        end
    end
